...
public class FormatterTests
{
            ...
            [
                FunctionDeclarationNode.Create(
                    ...
                    [
                        ...
                        new ParameterNode(default, "y", new TypeRefNode(default, null, ["i32"])),
                    ],
                    new TypeRefNode(default, null, ["void"]),
                    new BlockStatementNode(default)),
                FunctionDeclarationNode.Create(
                    ...
                    new BlockStatementNode(default, [
                        new IfStatementNode(
                            ...
                            new BinaryExpressionNode(
                                ...
                                BinaryExpressionKind.LessThan,
                                new MemberAccessExpressionNode(default, "x"),
                                new LiteralExpressionNode(default, LiteralExpressionKind.I32, 0)
                            ),
                            new BlockStatementNode(default, [
                                new ReturnStatementNode(
                                    default,
                    ...
                    new BlockStatementNode(default, [
                        new ReturnStatementNode(
                            ...
                            new CallExpressionNode(
                                ...
                                [
                                    new LiteralExpressionNode(default, LiteralExpressionKind.I32, 1),
                                    new LiteralExpressionNode(default, LiteralExpressionKind.I32, 2),
                                ]
                            )
                        )
                    ])),
        ...
        var tree = new SyntaxTree(
            ...
            [
                FunctionDeclarationNode.Create(
                    ...
                    AccessModifier.Public,
                    "add",
                    [new ParameterNode(default, "x", new ArrayTypeNode(default, new TypeRefNode(default, null, ["i32"])))],
                    new TypeRefNode(default, null, ["void"]),
                    new BlockStatementNode(default, [
                        new ReturnStatementNode(
                            default,
        ...
        var tree = new SyntaxTree(
            ...
            [
                new TypeDeclarationNode(
                    ...
                    [],
                    [
                        new PropertyDeclarationNode(default, "x", new TypeRefNode(default, null, ["i32"])),
                        new PropertyDeclarationNode(default, "y", new TypeRefNode(default, null, ["i32"])),
                    ],
                    [],
                    []
                )
                    ...
                    [
                        new PropertyDeclarationNode(
                            ...
                            new PropertyGetterNode(
                                ...
                                new BlockStatementNode(default, [
                                    new ReturnStatementNode(default, new LiteralExpressionNode(default, LiteralExpressionKind.I32, 0))
                                ])
                            ),
                ...
                new TypeDeclarationNode(
                    ...
                    [
                        new MethodDeclarationNode(
                            ...
                            "toString",
                            [],
                            new TypeRefNode(default, null, ["string"]),
                            new BlockStatementNode(default)),
                        new MethodDeclarationNode(
                            default,
                            AccessModifier.Public,
                            false,
                            "distance",
                            [new ParameterNode(default, "other", new TypeRefNode(default, null, ["Point"]))],
                            new TypeRefNode(default, null, ["string"]),
                            new BlockStatementNode(default)),
                    ])
            ]);
        ...
        var tree = new SyntaxTree(
            ...
            [
                new TypeDeclarationNode(
                    ...
                    "MyType",
                    [],
                    [new TypeRefNode(default, null, ["Interface1"]), new TypeRefNode(default, null, ["Interface2"])],
                    [],
                    [],
                    []
                )
    ...
    public void FormatTypeAliasTest()
    {
        var tree = new SyntaxTree(
            ...
            [],
            [
                new AliasDeclarationNode(default, AccessModifier.Public, "MyType", [], new TypeRefNode(default, null, ["i32"]))
            ]);
        var formatted = tree.ToString();
        const string expected = "namespace Test1;\n\npublic type MyType = i32;";
            ...
            [
                new AliasDeclarationNode(
                    ...
                    new FunctionTypeNode(
                        default,
                        [new TypeRefNode(default, null, ["i32"]), new TypeRefNode(default, null, ["i32"])],
                        new TypeRefNode(default, null, ["i32"])
                    )
                )
            ]);
        var formatted = tree.ToString();
        const string expected = "namespace Test1;\n\npublic type MyType = (i32, i32) => i32;";
                ...
                FunctionDeclarationNode.Create(
                    ...
                    new BlockStatementNode(default, [
                        new VariableDeclarationNode(
                            default,
                            "x",
                            new FunctionTypeNode(default, [], new TypeRefNode(default, null, ["void"])),
                            new LiteralExpressionNode(default, LiteralExpressionKind.I32, 0)
                        )
                    ]))
            ]);
                ...
                FunctionDeclarationNode.Create(
                    ...
                    new BlockStatementNode(default, [
                        new VariableDeclarationNode(
                            ...
                            new FunctionTypeNode(
                                default,
                                [new TypeRefNode(default, null, ["i32"]), new TypeRefNode(default, null, ["f64"])],
                                new TypeRefNode(default, null, ["void"])
                            ),
                            new LiteralExpressionNode(default, LiteralExpressionKind.I32, 0)
                        )
            ...
            [
                new AliasDeclarationNode(
                    ...
                    new InterfaceNode(
                        default,
                        [
                            new InterfacePropertyNode(default, "x", new TypeRefNode(default, null, ["i32"]), null, null),
                            new InterfacePropertyNode(default, "y", new TypeRefNode(default, null, ["i32"]), null, null),
                        ],
                        [
                            new InterfaceMethodNode(
                                ...
                                new TypeRefNode(default, null, ["f64"])
                            )
                        ]
                    )
                )
            ...
            [
                new AliasDeclarationNode(
                    ...
                    new InterfaceNode(
                        default,
                        [
                            new InterfacePropertyNode(default, "x", new TypeRefNode(default, null, ["i32"]), AccessModifier.Public, AccessModifier.Public),
                            new InterfacePropertyNode(default, "y", new TypeRefNode(default, null, ["i32"]), AccessModifier.Private, AccessModifier.Private),
                        ],
                        [
                            new InterfaceMethodNode(
                                default,
            ...
            [
                new AliasDeclarationNode(
                    ...
                    new DiscriminatedUnionNode([
                        new TypeRefNode(default, null, ["i8"]),
                        new TypeRefNode(default, null, ["i16"]),
                        new TypeRefNode(default, null, ["i32"]),
                        new TypeRefNode(default, null, ["i64"]),
                    ]))
            ]);
        var formatted = tree.ToString();
        const string expected = "namespace Test1;\n\npublic type Numbers = i8 | i16 | i32 | i64;";
        ...
        var tree = new SyntaxTree(
            ...
            [
                new AliasDeclarationNode(
                    ...
                    new DiscriminatedUnionNode([
                        new FunctionTypeNode(default, [], new TypeRefNode(default, null, ["void"])),
                        new FunctionTypeNode(default, [new TypeRefNode(default, null, ["i32"]), new TypeRefNode(default, null, ["i32"])], new TypeRefNode(default, null, ["i32"]))
                    ]))
            ]);
        var formatted = tree.ToString();
        const string expected = "namespace Test1;\n\npublic type F = () => void | (i32, i32) => i32;";
    ...
    public void FormatNullTest()
    {
        var tree = new SyntaxTree(
            ...
            [],
            [
                FunctionDeclarationNode.Create(default, AccessModifier.Public, "main", [], new TypeRefNode(default, null, ["void"]),
                    new BlockStatementNode(default, [
                        new VariableDeclarationNode(
                            default,
                            "x",
                            new DiscriminatedUnionNode([new TypeRefNode(default, null, ["i32"]), new TypeRefNode(default, null, ["null"])]),
            ...
            [
                new AliasDeclarationNode(
                    ...
                    new TupleTypeNode(default, [
                        new TypeRefNode(default, null, ["bool"]),
                        new TypeRefNode(default, null, ["i32"]),
                    ]))
            ]);
        var formatted = tree.ToString();
        const string expected = "namespace Test1;\n\npublic type T = (bool, i32);";
        ...
        var tree = new SyntaxTree(
            ...
            [
                new AliasDeclarationNode(
                    ...
                    [],
                    new TupleTypeNode(default, [
                        new TupleTypeNode(default, [new TypeRefNode(default, null, ["bool"]), new TypeRefNode(default, null, ["i8"])]),
                        new TypeRefNode(default, null, ["i32"]),
                    ]))
            ]);
        var formatted = tree.ToString();
        const string expected = "namespace Test1;\n\npublic type T = ((bool, i8), i32);";
                    ...
                    new BlockStatementNode(default, [
                        new ReturnStatementNode(
                            ...
                            new TupleExpressionNode(default, [
                                new LiteralExpressionNode(default, LiteralExpressionKind.Boolean, true),
                                new LiteralExpressionNode(default, LiteralExpressionKind.I32, 1)
                            ])
                        )
                    ]))
                        ...
                        new ReturnStatementNode(
                            ...
                            new NewObjectExpressionNode(
                                ...
                                new ArrayAccessExpressionNode(
                                    ...
                                    new LiteralExpressionNode(default, LiteralExpressionKind.I32, 10)
                                )
                            )
                        )
                    ])
        ...
        var tree = new SyntaxTree(
            ...
            [
                new TypeDeclarationNode(
                    ...
                    AccessModifier.Public,
                    "List",
                    [new TypeRefNode(default, null, ["T1, T2"])],
                    [],
                    [],
                    [],
                    []
            ...
            [
                new AliasDeclarationNode(
                    ...
                    new GenericApplicationNode(
                        ...
                        [new TypeRefNode(default, null, ["T1"]), new TypeRefNode(default, null, ["T2"])])
                )
            ]);
        var formatted = tree.ToString();
        const string expected = "namespace Test1;\n\npublic type Test = List<T1, T2>;";
        ...
        var tree = new SyntaxTree(
            ...
            [
                new AliasDeclarationNode(
                    ...
                    "T",
                    [new TypeRefNode(default, null, ["T1"]), new TypeRefNode(default, null, ["T2"])],
                    new DiscriminatedUnionNode([new TypeRefNode(default, null, ["T1"]), new TypeRefNode(default, null, ["T2"])])
                )
            ]);
        var formatted = tree.ToString();
        ...
        var tree = new SyntaxTree(
            ...
            [
                FunctionDeclarationNode.Create(
                    ...
                    AccessModifier.Public,
                    "test",
                    [new ParameterNode(default, "a", new TypeRefNode(default, null, ["i32"]))],
                    new TypeRefNode(default, null, ["bool"]),
                    new BlockStatementNode(default, [
                        new ReturnStatementNode(
                            default,
    ...
    [Test]
    [TestCase(LiteralExpressionKind.I8)]
    [TestCase(LiteralExpressionKind.I16)]
    [TestCase(LiteralExpressionKind.I64)]
    [TestCase(LiteralExpressionKind.U8)]
    [TestCase(LiteralExpressionKind.U16)]
    [TestCase(LiteralExpressionKind.U32)]
    [TestCase(LiteralExpressionKind.U64)]
    public void FormatNumberTest(LiteralExpressionKind kind)
    {
        var tree = new SyntaxTree(
            file,
            new NamespaceNode(default, ["Test1"]),
            ...
            [
                new FunctionDeclarationNode(
                    ...
                    new BlockStatementNode(default, [
                        new ReturnStatementNode(
                            default,
                            new LiteralExpressionNode(default, kind, 1)
                        )
                    ])
                )
            ]);
        ...
        var expected =
            $$"""
              ...
              public test(): void {
                  return 1{{kind.ToString().ToLowerInvariant()}};
              }
              """;
            ...
            [
                new FunctionDeclarationNode(
                    ...
                    new BlockStatementNode(default, [
                        new ReturnStatementNode(
                            default,
                            new LiteralExpressionNode(default, LiteralExpressionKind.F64, 3.14)
                        )
                    ])
                )
            ]);
    ...
    public void FormatUseTest()
    {
        var tree = new SyntaxTree(
            ...
            [
                new UseNode(default, null, ["Test", "SubNamespace", "SubSubNamespace"])
            ],
            [
                new FunctionDeclarationNode(
                    default,
    ...
    [Test]
    public void FormatUseWithPackageTest()
    {
        var tree = new SyntaxTree(
            file,
            new NamespaceNode(default, ["Test", "Test2"]),
            [
                new UseNode(default, "pkg", ["Test", "SubNamespace", "SubSubNamespace"])
            ],
            [
                new FunctionDeclarationNode(
                    default,
        ...
        const string expected =
            ...
            use pkg::Test.SubNamespace.SubSubNamespace;
    ...
    [Test]
    public void FormatTypeWithPackageTest()
    {
        var tree = new SyntaxTree(
            file,
            new NamespaceNode(default, ["Test", "Test2"]),
            ...
            [
                new FunctionDeclarationNode(
                    ...
                    "main",
                    [],
                    new TypeRefNode(default, "pkg", ["NS1", "MyType"]),
                    new BlockStatementNode(default, []))
            ]);
        var formatted = tree.ToString();
        const string expected =
